...
class IssueCredentialV1 extends Endpoint {
  ...
  async records({connection_id, role, state, thread_id}){
    let response = await this.axios.get('/issue-credential/records', {
      params: {
        connection_id,
        role,
        state,
  ...
  async record(cred_ex_id) {
    let response = await this.axios.get(`/issue-credential/records/${cred_ex_id}`);
    return {
      status:   response.status,
  ...
  async create(body) {
    let response = await this.axios.post('/issue-credential/create', body)
  ...
  async send(body) {
    let response = await this.axios.post('/issue-credential/send', body)
    return {
      status:   response.status,
      results:  response.data
    }
  ...
  async sendProposal(body) {
    let response = await this.axios.post('/issue-credential/create-proposal', body)
    return {
      status:   response.status,
      results:  response.data
    }
  ...
  async sendOffer(body) {
    let response = await this.axios.post('/issue-credential/create-offer', body)
    return {
      status:   response.status,
      results:  response.data
    }
  ...
  // @param {String} cred_ex_id [Credential exchange identifier]
  async recordsSendOffer(cred_ex_id) {
    let response = await this.axios.post(`/issue-credential/records/${cred_ex_id}/send-offer`);
    return {
      status:   response.status,
      results:  response.data
    }
  ...
  // @param {String} cred_ex_id [Credential exchange identifier]
  async recordsSendRequest(cred_ex_id) {
    let response = await this.axios.post(`/issue-credential/records/${cred_ex_id}/send-request`);
    return {
      status:   response.status,
      results:  response.data
    }
  ...
  // @param {String} cred_ex_id [Credential exchange identifier]
  async recordsIssue(cred_ex_id) {
    let response = await this.axios.post(`/issue-credential/records/${cred_ex_id}/issue`);
    return {
      status:   response.status,
      results:  response.data
    }
  ...
  async recordsStore(cred_ex_id, body) {
    let response = await this.axios.post(`/issue-credential/records/${cred_ex_id}/store`, body);
    return {
      status:   response.status,
      results:  response.data
    }
  ...
  async revoke(cred_ex_id, rev_reg_id, { publish }) {
    let response = await this.axios.post(`/issue-credential/records/${cred_ex_id}/store`, {
      rev_reg_id,
      publish
    });
    return {
  ...
  async publishRevocations(body) {
    let response = await this.axios.post(`/issue-credential/publish-revocations`, body);
    return {
      status:   response.status,
      results:  response.data
    }
  ...
  async publishRevocations(body) {
    let response = await this.axios.post(`/issue-credential/clear-pending-revocations`, body);
    return {
      status:   response.status,
      results:  response.data
    }
  ...
  async publishRevocations(cred_ex_id) {
    let response = await this.axios.post(`/issue-credential/recoeds/${cred_ex_id}/remove`);
    return {
      status:   response.status,
      results:  response.data
    }
  ...
  // @param {String} cred_ex_id [Credential exchange identifier]
  async recordsProblemReport(cred_ex_id) {
    let response = await this.axios.post(`/issue-credential/recoeds/${cred_ex_id}/problem-report`);
    return {
      status:   response.status,
      results:  response.data
    }
