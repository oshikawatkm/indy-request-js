...
class Connection extends Endpoint {
  ...
  async receiveInvitation({ id, did, imageUrl, label, recipientKeys, routingKeys, serviceEndpoint }) {
    let response = await this.axios.post('/connections/create-invitation', {
      '@id': id, 
      did, 
      imageUrl, 
      label, 
