...
class Connection extends Endpoint {
  ...
  async createInvitation({ alias, auto_accept, multi_use, public }, body) {
    let response = await this.axios.post('/connections/create-invitation', body, { params: { alias, auto_accept, multi_use, public }})
    return {
      status: response.status,
